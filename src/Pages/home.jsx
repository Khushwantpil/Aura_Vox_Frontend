  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] overflow-hidden">
      ...
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20">
        <div className="absolute inset-0 bg-gradient-to-b from-cyan-100 via-white to-cyan-100" />
        <div className="absolute top-0 left-1/4 w-[320px] h-[320px] bg-cyan-500/40 blur-3xl rounded-full" />
        <div className="absolute bottom-0 right-1/4 w-[320px] h-[320px] bg-cyan-500/40 blur-3xl rounded-full" />

        <div className="relative max-w-6xl mx-auto">
          <div className="flex justify-center">
            <span className="inline-flex items-center gap-2 bg-white border border-cyan-100 shadow-sm text-cyan-600 text-xs sm:text-sm font-semibold px-4 py-2 rounded-full">
          ...
          <div className="text-center mt-10 sm:mt-12">
            ...
            <p className="mt-6 text-[#64748b] text-lg sm:text-xl leading-relaxed max-w-2xl mx-auto font-medium">
            ...
            <div className="mt-10 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              <button
                ...
                className="px-8 py-4 rounded-2xl bg-gradient-to-r from-[#00C2CB] to-[#00D28E] text-white font-semibold text-sm sm:text-base shadow-[0_12px_40px_rgba(6,182,212,0.25)] hover:scale-[1.02] transition-all cursor-pointer"
              >
      ...
      <section className="py-24 bg-white border-t border-slate-100/80 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-cyan-100/10 blur-[130px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-32 h-fit mb-4 lg:mb-0">
              <span className="inline-flex items-center gap-2 bg-cyan-50 border border-cyan-100/80 px-4 py-1.5 rounded-full mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-cyan-500 text-xs font-semibold">
                  Setup Guide
                </span>
              </span>
            ...
            <div ref={containerRef} className="lg:col-span-7 relative pl-8 md:pl-10">
              ...
              <div 
                className="absolute left-[9px] top-2 bottom-2 w-[2px] bg-gradient-to-b from-cyan-500 via-cyan-500 to-cyan-500 rounded-full transition-transform duration-150 ease-out origin-top" 
                style={{ 
                    ...
                    <div key={step.id} className="relative group">
                      ...
                      <div 
                        className={`absolute left-[-31px] md:left-[-33px] top-6 w-4 h-4 rounded-full border-3 border-white shadow-sm z-10 transition-all duration-500 ${
                          isActive 
                            ? 'bg-cyan-600 scale-110 shadow-purple-/' 
                            : 'bg-slate-200'
                        }`}
                      />
                      ...
                      <div 
                        className={`bg-white border p-6 rounded-[24px] transition-all duration-700 ease-out transform ${
                          isActive 
                            ? 'border-cyan-200 shadow-[0_15px_40px_rgba(168,85,247,0.03)] translate-y-0 opacity-100' 
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full tracking-wide uppercase ${
                            isActive ? 'bg-cyan-50 text-cyan-600' : 'bg-slate-50 text-slate-400'
                          }`}>
                            0{step.id}
                          </span>
